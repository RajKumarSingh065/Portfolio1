...
function ThreatMap() {
  ...
  return (
    <div className="holo-panel relative mx-auto aspect-square w-full max-w-[520px] overflow-hidden">
      <div className="absolute inset-6 border border-[#7CFF00]/20" />
      <div className="radar-sweep absolute inset-8 rounded-full border border-[#7CFF00]/25" />
      ...
      <div className="absolute bottom-6 right-6 flex items-center gap-2 border border-[#7CFF00]/30 bg-black/45 px-3 py-2 font-mono text-[10px] uppercase tracking-[0.22em] text-[#7CFF00]">
        <FiShield />
        shield.sync
      </div>
    </div>
    ...
    <section id="home" className="relative flex min-h-screen flex-col justify-center overflow-hidden px-4 pb-12 pt-28 sm:px-6 lg:px-8">
      <div className="mx-auto grid w-full max-w-7xl items-center gap-10 lg:grid-cols-[1.12fr_0.88fr]">
        <motion.div
          ...
          className="max-w-4xl"
        >
          <p className="mb-5 font-mono text-xs uppercase tracking-[0.24em] text-[#7CFF00]">
      ...
      >
        ...
        <article className="home-feature-panel">
          <div>
            <p className="font-mono text-xs uppercase tracking-[0.24em] text-[#7CFF00]">featured operation</p>
          ...
          <a href="/projects/" className="mt-6 inline-flex items-center gap-2 font-mono text-xs uppercase tracking-[0.16em] text-[#7CFF00]">
            inspect project <FiArrowUpRight />
          </a>
        </article>
      </motion.div>
    </section>
